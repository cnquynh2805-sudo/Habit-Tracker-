...
content = content.replace(
  /<View style=\{tabStyles\.activeTabIndicatorCapsule\}>/g,
...
content = content.replace(
  /<\/View>\s*\{isExpanded && <Text style=\{tabStyles\.tabBarLabelTextActive\}>([^<]+)<\/Text>\}\s*<\/View>/g,
...
content = content.replace(
  /\{isExpanded && <Text style=\{tabStyles\.tabBarLabelText\}>([^<]+)<\/Text>\}/g,
  "{isExpanded && <Text style={tabStyles.tabBarLabelText} adjustsFontSizeToFit={true} numberOfLines={1}>$1</Text>}",
);
